            ...
            <div class="layui-col-md12">
                <div class="layui-card" >
                    <div class="layui-card-body ">
                        <form class="layui-form layui-col-space6" style="margin-left: 19%" method="get" action="{{ url('admin/user/indexAd') }}">
                            {{--  选择表单  --}}
                    ...
                    <div class="layui-card-header">
                        ...
                        <button class="layui-btn" onclick="xadmin.open('添加管理员','{{ url('admin/user/createAd') }}',600,400)"><i class="layui-icon"></i>添加</button>
                    </div>
