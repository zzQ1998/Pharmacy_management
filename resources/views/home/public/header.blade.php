<header class="header-wrap" id="nav-scroll">
    <div class="nav-wrap">
        <div class="logo-title">
            <a href="/" alt="Blog_Zer" title="Blog_Zer"> Blog_Zer </a>
        </div>
        <!-- Toggle menu -->
    ...
    @else
        <!-- Login status -->
            ...
            <div id="login-reg">
                ...
                {{--  <span> <a href="'{{ url('/phoneregister') }}'">注册</a></span>  --}}
            </div>
            <!-- /.Login status -->
        ...
        <nav id="primary-navigation" class="site-navigation primary-navigation " role="navigation">
            <div class="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95-container">
                <ul id="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95" class="nav-menu">
                    <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-4324"><a href="{{ url('index') }}">首页</a>
                    </li>
                    {{--  将一级分类，二级分类显示到视图上  --}}
                    @foreach($cateone as $k=>$v)
                        ...
                        @else
                            <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-4324"><a href="{{ url('/lists/'.$v->cate_id) }}">{{ $v->cate_name }}</a>
                        @endif
                        @if(!empty($catetwo[$k]))
                        <ul class="sub-menu">
