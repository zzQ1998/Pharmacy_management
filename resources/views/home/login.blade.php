...
<body class="login login-action-login wp-core-ui  locale-zh-cn" onload="getCookie();" style="background:rgba(57,61,73,.2);">
<div id="login">
    <h1><a href="/login" title="BlogZer" tabindex="-1">BlogZer</a></h1>
